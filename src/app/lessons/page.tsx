      ...
      <main className="bg-background text-foreground font-sans">
        ...
        <section className="section-container bg-muted/30">
          ...
          <div
            ...
            className="scroll-mt-24 mt-12 max-w-4xl bg-white p-8 rounded-lg shadow-sm"
          >
            ...
            <div className="space-y-4 text-[0.9375rem] leading-relaxed">
              <p>
                Perfect for those with no prior dance experience. This
                comprehensive 6-week course introduces you to the fundamentals
                of ballroom and Latin dancing in a supportive, friendly
                environment.
              </p>
              <div>
              ...
              <div className="pt-4">
                <a
                  href="/contact?lesson=Absolute Beginners"
          ...
          >
            ...
            <div className="space-y-4 text-[0.9375rem] leading-relaxed">
              <p>
                For dancers who have completed a beginner course or have some
                social dancing experience. Build on your foundation and expand
                your repertoire with more complex figures and styling.
              </p>
              <div>
                <h4 className="font-semibold text-lg mb-2">
                  What You'll Learn:
                ...
                <ul className="list-disc list-inside space-y-2 text-muted ml-4">
                  ...
                  <li>
                    Introduction to additional dance styles (Quickstep, Rumba)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-muted ml-4">
                  ...
                  Comfortable with basic figures in at least 2-3 dances.
                </p>
              </div>
              <div className="pt-4">
          ...
          >
            ...
            <div className="space-y-4 text-[0.9375rem] leading-relaxed">
              <p>
                Monthly intensive workshops focusing on specific technical
                aspects of dance. Perfect for dancers of all levels looking to
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted ml-4">
                  ...
                  <li>
                    Dance-specific techniques (rotation, Cuban motion, etc.)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted ml-4">
                  ...
                  <li>
                    Suitable for all levels (content adapted to participants)
                  </li>
                </ul>
              </div>
              <div className="pt-4">
                <a
                  href="/contact?lesson=Technique Workshop"
                  className="btn btn-primary"
                >
                  Register interest
                </a>
          ...
          >
            ...
            <div className="space-y-4 text-[0.9375rem] leading-relaxed">
              <p>
                Receive personalised attention and accelerated progress with
                private coaching sessions tailored to your specific goals and
                needs.
              </p>
              <div>
              ...
              <div>
                ...
                <p className="text-muted ml-4">
                  Available in 45-minute or 60-minute sessions. Packages
                  available for multiple lessons.
                </p>
              </div>
              <div className="pt-4">
                <a
                  href="/contact?lesson=One-to-One Coaching"
                  className="btn btn-primary"
                >
                  Enquire now
                </a>
          ...
          >
            ...
            <div className="space-y-4 text-[0.9375rem] leading-relaxed">
              <p>
                Make your first dance truly memorable with personalised
                choreography and coaching designed around your chosen song and
                comfort level.
              </p>
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-muted ml-4">
                  ...
                  <li>
                    Adapted to your experience level (from simple to
                    spectacular)
                  </li>
              ...
              <div>
                ...
                <p className="text-muted ml-4">
                  We recommend starting 2-3 months before your wedding day for
                  best results. Rush packages available for shorter timelines.
                </p>
              </div>
              <div className="pt-4">
                <a
                  href="/contact?lesson=Wedding First Dance"
                  className="btn btn-primary"
                >
                  Get a quote
                </a>
